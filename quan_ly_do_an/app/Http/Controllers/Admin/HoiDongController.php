...
class HoiDongController extends Controller
{
    ...
    public function pageAjax(Request $request)
    {
        ...
        $hoiDongs = $query->orderBy('ma_hoi_dong', 'desc')->paginate($limit);
        $thietLaps = ThietLap::orderBy('ma_thiet_lap', 'desc')->get();
    ...
    public function them()
    {
        ...
        $chuyenNganhs = BoMon::get();
        return view('admin.hoidong.them', compact('giangViens', 'chuyenNganhs'));
    }
    ...
    public function xacNhanHuy(Request $request)
    {
        ...
        HoiDongGiangVien::where('ma_hoi_dong', $ma_hoi_dong)->update([
            'da_huy' => 1
        ]);
