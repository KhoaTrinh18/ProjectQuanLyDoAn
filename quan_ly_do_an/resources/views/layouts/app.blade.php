...
<body>
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li class="sidebar-item {{ request()->is('hoi-dong*') ? 'active' : '' }}">
                            <a class="sidebar-link" href="{{ route('hoi_dong.danh_sach') }}">
                                <i class="align-middle bi bi-collection-fill"></i> <span class="align-middle">Hội
                                    đồng</span>
                            </a>
                        </li>
                        ...
                        <li class="sidebar-item {{ request()->is('hoc-vi*') ? 'active' : '' }}">
                            <a class="sidebar-link" href="{{ route('hoc_vi.danh_sach') }}">
                                <i class="align-middle bi bi-briefcase"></i> <span class="align-middle">Học vị</span>
                            </a>
                        </li>
                ...
                <div class="navbar-collapse collapse">
                    ...
                    <ul class="navbar-nav navbar-align">
                        <li class="nav-item d-flex align-items-center">
                            ...
                            <div class="modal fade" id="myModal1" tabindex="-1" aria-labelledby="modalLabel">
                                <div class="modal-dialog">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.open-modal1').on('click', function(e) {
                e.preventDefault();
                var url = $(this).attr('href');
