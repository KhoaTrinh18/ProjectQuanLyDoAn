@extends('layouts.app')
@section('title', 'Chấm điểm đề tài hội đồng')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h2 style="font-weight: bold">Chấm điểm đề tài hội đồng</h2>
                    </div>
                    <div class="card-body">
                        ...
                        <form id="form_cham_diem">
                            ...
                            @foreach ($deTai->sinhVienHoiDongs as $i => $sinhVien)
    ...
    <script>
        $(document).ready(function() {
            $("#chamDiem").click(function(event) {
                ...
                $.ajax({
                    url: "{{ route('cham_diem_hoi_dong.xac_nhan_cham_diem') }}",
                    type: "POST",
                    data: formData,
                    contentType: false,
                    processData: false,
