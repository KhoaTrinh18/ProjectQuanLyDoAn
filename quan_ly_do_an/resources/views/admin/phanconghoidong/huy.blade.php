@extends('layouts.app')
@section('title', 'Hủy phân công hội đồng')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h2 style="font-weight: bold">Hủy phân công hội đồng</h2>
                    </div>
                    <div class="card-body" style="font-size: 16px">
                        ...
                        <form id="form_huy">
                            ...
                            <div class="text-center">
                                <a href="{{ route('phan_cong_hoi_dong.danh_sach') }}"
    ...
    <script>
        $(document).ready(function() {
            $("#huy").click(function(event) {
                ...
                $.ajax({
                    url: "{{ route('phan_cong_hoi_dong.xac_nhan_huy') }}",
                    type: "POST",
                    data: formData,
                    contentType: false,
                    processData: false,
