                    ...
                    <div class="card-body">
                        <form class="d-flex mb-3" id="form_tim_kiem">
                            ...
                            <div class="d-flex flex-column ms-3" style="width: 400px">
                                ...
                                <div class="d-flex align-items-center justify-content-between mt-2">
                                    <label for="giang_vien_phan_bien">Giảng viên phản biện:</label>
                                    <select class="form-select ms-2 shadow-none" name="giang_vien_phan_bien" style="width: 240px">
                                        <option value="" selected disabled hidden>Chọn giảng viên</option>
                                        <option value="">Tất cả</option>
                                        @foreach ($chuyenNganhs as $chuyenNganh)
                                            <optgroup label="{{ $chuyenNganh->ten_bo_mon }}">
                        ...
                        @include('admin.phancongphanbien.pageAjax', ['deTais' => $deTais])
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchData(page = 1, searchParams = null) {
                ...
                $.ajax({
                    url: "{{ route('phan_cong_phan_bien.page_ajax') }}",
                    type: "GET",
                    data: requestData,
                    dataType: 'json',
